...
# Disable dedicated clock routing for ledSel_IBUF[1] to avoid multiple drivers
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ledSel_IBUF[1]] 

# Pin assignments for ledSel
